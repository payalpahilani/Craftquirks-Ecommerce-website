<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="craftquirks.products" %>
			...
			<div class="container">
				...
				<div class="row products_row products_container grid">
					...
					<div class="col-xl-4 col-md-6 grid-item hot">
						<div class="product">
							<div class="product_image"><img src="images1/p1.jpg" alt="" height="340px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="Hp1" runat="server" NavigateUrl="~/MA.aspx">Memory Album</asp:HyperLink></div>
					...
					<div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p2.jpg" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="Hp2" runat="server" NavigateUrl="~/EB.aspx">Explosion Box</asp:HyperLink>
                                            </div>
										</div>
									</div>
								</div>
					...
					<div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p3.jpg" alt="" height="340px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="Hp3" runat="server" NavigateUrl="~/SB.aspx">Scrapbook</asp:HyperLink>
                                                </div>
										</div>
									</div>
							</div>
					...
					<div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p5.jpg" alt="" height="340px" width="350px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="Hp4" runat="server" NavigateUrl="~/IB.aspx">Infinity Explosion Box</asp:HyperLink>
                                                </div>
										</div>
									</div>
							</div>
                    ...
                    <div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p6.jpg" alt="" height="340px" width="350px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/TEB.aspx">Tower Explosion Box</asp:HyperLink>
                                                </div>
										</div>
									</div>
							</div>
                    ...
                    <div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p8.jpg" alt="" height="340px" width="350px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/CEB.aspx">Chocolate Explosion Box</asp:HyperLink>
                                                </div>
										</div>
									</div>
							</div>
                    ...
                    <div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p7.jpeg" alt="" height="340px" width="350px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/NA.aspx">Name Album</asp:HyperLink>
                                                </div>
										</div>
									</div>
							</div>
                    ...
                    <div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p9.jpg" alt="" height="340px" width="350px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/cards.aspx">Cards</asp:HyperLink>
                                                </div>
										</div>
									</div>
							</div>
                    ...
                    <div class="col-xl-4 col-md-6 grid-item sale">
						<div class="product">
							<div class="product_image"><img src="images1/p10.jpg" alt="" height="340px" width="350px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/AP.aspx">Additional Prdoducts</asp:HyperLink>
                                                </div>
										</div>
									</div>
							</div>
