<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MA.aspx.cs" Inherits="craftquirks.MA" %>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample05">
          <ul class="navbar-nav pl-md-5 ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <asp:HyperLink ID="HyperLink3" runat="server" CssClass="dropdown-item" NavigateUrl="~/makeyourown.aspx">Make your Own</asp:HyperLink>
                   <asp:HyperLink ID="HyperLink2" runat="server" CssClass="dropdown-item" NavigateUrl="~/products.aspx">Finished Products</asp:HyperLink>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
              <asp:HyperLink ID="HyperLink4" runat="server" CssClass="nav-link" NavigateUrl="login.aspx" Text="Login"/>
            </li>
          ...
          <div class="navbar-nav ml-auto">
            <form method="post" class="search-form" id="form2">
