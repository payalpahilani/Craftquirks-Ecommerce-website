<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TEB.aspx.cs" Inherits="craftquirks.TEB" %>
...
<asp:Repeater ID="d1" runat="server">
                ...
                <!-- Product -->
					<div class="col-xl-4 col-md-6 grid-item new">
						<div class="product">
							<div class="product_image"><img src="<%#Eval("p_img") %>" alt="" height="340px" width="350px"></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">
                                                <a href="pro_desc.aspx?id=<%#Eval("p_id") %>"><%#Eval("p_name") %></a></div>
											
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right"><span><%#Eval("p_price") %></span>$</div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
										<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
											<div><div><img src="images1/heart_2.svg" class="svg" alt=""><div>+</div></div></div>
										</div>
										<div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
											<div><div><img src="images1/cart.svg" class="svg" alt=""><div>+</div></div></div>
										</div>
									</div>
								</div>
							</div>
